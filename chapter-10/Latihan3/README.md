...
**Chapter 10 · Analitik Aliran Data** | Estimasi waktu: **35 menit**
...
- [ ] Stack Kafka masih berjalan (`docker compose ps` dari `Konfigurasi-lab/`)
...
| Pipeline Spark | `spark/streaming_agregasi.py` |
| Producer | `scripts/producer_transaksi.py` |
| Spark UI | http://localhost:4040 |
| Kafka UI | http://localhost:8080 |
| Checkpoint | `/tmp/checkpoints/streaming-agregasi/` |
...
Buka Terminal 1 (jika belum berjalan dari Latihan 2):
...
Buka `Konfigurasi-lab/spark/streaming_agregasi.py` dan pahami tiga bagian utamanya:
...
Buka Terminal 2 (baru, terpisah dari terminal producer):
