"""Seed Silver transaksi (sama Bab 12 buat_data_viz) — prasyarat pipeline Ch.14."""
import random
import uuid
...
KOTA = [
    ...
    "Semarang", "Palembang", "Yogyakarta", "Depok", "Tangerang",
]
N = 15_000
...
def main() -> None:
    random.seed(42)
    spark = create_spark("Seed-Silver-Ch14")
    ...
    print(f"[OK] Silver: {df.count():,} baris → {SILVER}")
    spark.stop()
